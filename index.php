            ...
            <div class="col-lg-6 col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
                ...
                <!-- <div class="row g-4 justify-content-between mb-5">
                        ...
                        <div class="col-lg-6 col-xl-7">
                            ...
                            <p class="text-dark mb-0"><i class="fas fa-check-circle text-primary me-1"></i> Partnerships
                            </p>
                        </div>
                    </div> -->
                <!-- <div class="row g-4 justify-content-between mb-5">
...
<div class="container-fluid service py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            ...
            <h1 class="display-4">How We Can Help You</h1>
        </div>
                ...
                <div class="service-item bg-light rounded">
                    ...
                    <div class="service-content text-center p-4">
                        <div class="service-content-inner">
                            <a href="migration.php" class="h4 mb-4 d-inline-flex text-start">
                                <!--  <i class="fas fa-donate fa-2x me-2"></i> -->Migration</a>
                            <!-- <p class="mb-4">We provide a wide range of standardized tests preparation materials.
                                    These facilities are available at the modern library. Leaflets, brochures, handbooks
                                    & other publications from universities / colleges from different countries are
                                    available…
                                </p>
                    ...
                    <div class="service-content text-center p-4">
                        <div class="service-content-inner">
                            <a href="#" class="h4 mb-4 d-inline-flex text-start"><!--<i
                                        class="fas fa-donate fa-2x me-2"></i> -->Education</a>
                            <!-- <p class="mb-4"></p>
                                <a class="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>-->
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-light rounded">
                    ...
                    <div class="service-content text-center p-4">
                        <div class="service-content-inner">
                            <a href="#" class="h4 mb-4 d-inline-flex text-start"><!--<i
                                        class="fas fa-donate fa-2x me-2"></i>-->Professional Year</a>
                            <!--  <p class="mb-4">Getting to know different education providers is vital in choosing the
                                    right school for a student. We help organize introductory events with various
                                    education providers where students can interact with a representative…
                                </p>
                                <a class="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>-->
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-light rounded">
                    ...
                    <div class="service-content text-center p-4">
                        <div class="service-content-inner">
                            <a href="#" class="h4 mb-4 d-inline-flex text-start"><!--<i
                                        class="fas fa-donate fa-2x me-2"></i>-->NAATI|PTE</a>
                            <!--  <p class="mb-4">Getting to know different education providers is vital in choosing the
                                    right school for a student. We help organize introductory events with various
                                    education providers where students can interact with a representative…
                                </p>
